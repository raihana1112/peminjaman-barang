                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="#">Ketersediaan Barang</a>
                            </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <h1 class="text-white mb-4 pb-2">Cek Ketersediaan Proyektor dan Kunci Ruangan Lab</h1>

                            <a href="#section_2" class="btn custom-btn smoothscroll me-3">Lihat Lebih Lanjut</a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table text-center">
                                    ...
                                    <?php 
                                        ...
                                        END AS nim,
                                        CASE 
                                            WHEN p.status_ketersediaan = 'Sedang Dipinjam' THEN p.no_hp
                                            ELSE NULL
                                        END AS no_hp,
                                        CASE 
